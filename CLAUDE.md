...
- Cross-Coin Drawdown-vs-Deposit-Bremse (Schwelle `max_daily_drawdown` aus config.yaml, aktuell 10%; anchored an die Ersteinzahlung, **kein** täglicher Reset – siehe #132)
